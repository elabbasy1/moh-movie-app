  ...
  const renderMovieCard = (movie) => {
    ...
    return (
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black/60 text-white font-bold text-center text-lg py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          {movie.title}
        </div>
        ...
        <div className="flex flex-col items-center mt-2 px-2 w-full">
          {isFavorite(movie) ? (
            <button
              className="px-3 py-1 bg-red-600 text-white rounded mb-2 hover:bg-red-700 transition w-full"
              onClick={(e) => {
                e.stopPropagation();
            ...
            <button
              className="px-3 py-1 bg-green-600 text-white rounded mb-2 hover:bg-green-700 transition w-full"
              onClick={(e) => {
                e.stopPropagation();
                addFavorite(movie);
              }}
